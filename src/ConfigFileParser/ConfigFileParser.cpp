...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/16 12:07:35 by TryHardTeam       #+#    #+#             */
/*   Updated: 2024/12/16 12:07:36 by TryHardTeam      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ConfigFileParser::setAllConfigValues(catIt& catIt, itemIt& itemIt, valIt& valIt, Config& configStruct, int& i)
{
	...
	setConfigValue(catIt, itemIt, valIt, configStruct, "errorPage_501", CODE_501_NOT_IMPLEMENTED);
