...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/16 12:09:30 by TryHardTeam       #+#    #+#             */
/*   Updated: 2024/12/16 12:09:31 by TryHardTeam      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::fillMessageSend(const size_t i)
{
	...
	if (this->_clients[i].messageSend.empty())
	{
		...
		Server::printVector(this->_clients[i], this->_clients[i].sendBuffer,
		 	RED, static_cast<int>(INFO), true);
