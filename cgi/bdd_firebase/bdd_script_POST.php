...
<body style=\"font-family: Arial, sans-serif; padding: 20px;\">
    ...
    <p><strong>Email:</strong> " . $response_data['email'] . "</p>
    <p><strong>First Name:</strong> " . $response_data['first_name'] . "</p>
    <p><strong>Last Name:</strong> " . $response_data['last_name'] . "</p>
    <p><strong>Pet Name:</strong> " . (isset($response_data['pet name']) ? $response_data['pet name'] : 'No pet information') . "</p>
    <hr>
