...
*************************
"
docker run --rm -t jstarcher/siege -c50 -r50  "$ip:1512"  | grep -v "HTTP"
echo "
*************************
***Tests de Spike *******
*************************
"
docker run --rm -t jstarcher/siege -c100 -t10s  "$ip:1512"  | grep -v "HTTP"
...
************************************
"
docker run --rm -t jstarcher/siege -b -c10 -r20  "$ip:1512"  | grep -v "HTTP"
...
**********************************
"
docker run --rm -t jstarcher/siege -b -c50 -r50  "$ip:1512"  | grep -v "HTTP"
echo "
*********************************
***Tests de Spike BRUTEFORCE ****
*********************************
"
docker run --rm -t jstarcher/siege -b -c100 -t10s  "$ip:1512"  | grep -v "HTTP"
